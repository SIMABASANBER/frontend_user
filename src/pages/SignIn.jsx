          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleLogin}>
              ...
              <p className="text-sm text-center font-light text-gray-500 dark:text-gray-400">
                Belum memiliki akun? <a href="signup" className="font-medium text-[#293066] hover:underline dark:text-gray-500">Daftar Sekarang</a>
              </p>
              <button type="submit" className="w-full text-white bg-[#293066] hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                Sign in
              </button>
            </form>
          </div>
